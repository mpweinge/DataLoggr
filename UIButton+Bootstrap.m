...
-(void)bootstrapStyle{
    ...
    [self setTitleColor:[UIColor colorWithRed:0.7 green:0.7 blue:0.7 alpha:1] forState:UIControlStateNormal];
...
-(void)DLStyle {
  ...
  [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:0.25 green:0.25 blue:1 alpha:1]] forState:UIControlStateSelected];
}
